...
- データ互換性基盤：入出力スキーマのバージョン管理、旧形式の安全な移行、共通エンティティ参照
- 歴史日付：紀元前、年代、世紀、日付精度、原資料表記
- 閲覧操作：アプリ内最大化、Fullscreen API、年代線、時間スライサー、ミニマップ、年代ジャンプ、保存済みビュー
