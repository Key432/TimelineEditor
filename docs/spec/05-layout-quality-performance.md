...
- 中央：固定情報列＋タイムライン
- 右：項目編集、データ品質・重複統合、年代背景、プロジェクト設定、「種別・タグ・カスタムフィールド」管理、「出典・参考文献」管理、インポート／エクスポートを必要時のみサイドパネル表示
- タイムライン上部の管理操作は単一の「管理メニュー」から展開する。「データを整える」にデータ品質・重複統合、種別・タグ・カスタムフィールド、出典・参考文献をまとめ、「表示とプロジェクト」に年代背景、プロジェクト設定・共有、インポート／エクスポートをまとめる
